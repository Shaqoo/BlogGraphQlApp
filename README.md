...
```
cd existing_repo
git remote add origin https://gitlab.com/shakirullahohio/dockertestapp.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/shakirullahohio/dockertestapp/-/settings/integrations)
